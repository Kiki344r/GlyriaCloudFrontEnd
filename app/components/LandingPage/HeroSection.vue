<template>
  <div class="bg-dark">
    ...
    <div class="flex flex-col min-h-screen grid-background items-center justify-center gap-4">
      <h1 class="text-4xl w-xl max-w-screen text-center text-white">
      ...
      <div class="flex gap-4 mt-8 flex-wrap justify-center">
        <div class="flex flex-col gap-2 bg-gray-950 w-52 border-1 border-white/30 rounded-lg h-20 justify-center items-center text-center">
          <h2 class="text-white">
